...
if __name__ == '__main__':
    ...
    parser.add_argument('--savedir', default='./salmaps/SwinSal/', help='directory to save the results')
    parser.add_argument('--gpu', default=True, type=lambda x: (str(x).lower() == 'true'),shelp='Run on CPU or GPU. If TRUE, then GPU')
